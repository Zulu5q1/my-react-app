...
const ResultPage = () => {
    ...
    return <div>
        ...
        <div>
            ...
            {loading && <div className=" bg-orange-100 text-orange-500 font-bold text-xl justify-center h-screen flex items-center">Loading...</div>}
            ...
            {results.length > 0 && 
            <div className="w-full px-12 py-4 flex flex-wrap justify-center bg-orange-100 h-screen overflow-y-auto">
                {results.map((item, index) => (
                    <a key={index} href={item.link} target="_blank"  className="m-6 rounded-lg px-4 py-2 border border-orange-400 w-70 h-70 hover:bg-orange-300 justify-around flex flex-col items-center">
